...
- [Actividad registrada para Ultra](ejercicios-indagacion-y-repositorios.md): dos ejercicios obligatorios, uno de indagación y otro técnico en Google Colab, con entrega única en PDF.
...
- Antes de clase: lectura sobre la relación entre Big Data y Machine Learning.
- Durante la clase: laboratorio de métricas con datos desbalanceados.
- Después de clase: resolución de los dos ejercicios y preparación del PDF.

La actividad registrada contiene exactamente dos ejercicios obligatorios. Toda entrega debe citar fuentes y distinguir resultados observados de conclusiones generales.
